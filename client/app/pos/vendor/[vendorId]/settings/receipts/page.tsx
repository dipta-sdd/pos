...
export default function ReceiptSettingsPage() {
  ...
  return (
    <PermissionGuard permission="can_customize_receipts">
      <div className="p-6">
        <PageHeader title="Receipt Settings" description="Customize your sales receipts">
                ...
                <CardBody className="p-6">
                    ...
                    <div className="space-y-6">
                        <div className="p-12 bg-gray-50 border-2 border-dashed border-gray-200 rounded-lg text-center">
                            ...
                            <p className="text-sm text-gray-400">Configure your receipt header, footer, and logo</p>
                        </div>
