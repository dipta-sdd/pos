...
export default function SalesPage() {
  ...
  const renderCell = useCallback((item: any, columnKey: React.Key) => {
    if (columnKey === "customer") return item.customer ? `${item.customer.first_name} ${item.customer.last_name}` : "Walk-in";
  ...
  return (
    <PermissionGuard permission="can_view_sales_history">
      <div className="p-6">
        <PageHeader title="Sales History" description="View and manage sales transactions">
