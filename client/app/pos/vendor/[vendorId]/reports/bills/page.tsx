...
export default function BillsReportPage() {
  ...
  return (
    <PermissionGuard permission="can_view_reports">
      <div className="p-6">
        <PageHeader title="Financial Ledger" description="Detailed financial reports and billings">
            <Button variant="flat" startContent={<Download className="w-4 h-4" />}>Export PDF</Button>
        </PageHeader>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-lg font-medium">No financial data available for the selected period.</p>
        </div>
      </div>
    </PermissionGuard>
  );
