...
export default function InventoryReportPage() {
  ...
  return (
    <PermissionGuard permission="can_view_reports">
      <div className="p-6">
        <PageHeader title="Inventory Reports" description="Overview of stock levels and inventory value">
            <Button variant="flat" startContent={<Download className="w-4 h-4" />}>Export CSV</Button>
        </PageHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <Card className="bg-orange-50 dark:bg-orange-900/10 border-orange-100 dark:border-orange-800">
                <CardBody className="p-4 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs text-orange-600 font-bold uppercase tracking-wider">Low Stock</p>
