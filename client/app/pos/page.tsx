      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Select a vendor to manage your point of sale operations, or create a
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8 hover:shadow-xl transition-all duration-300">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                    Start a new business venture and set up your point of sale
                    system from scratch.
                  </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {user.memberships.map((membership) => (
                    <div
                      ...
                      onClick={() => handleVendorSelect(membership.vendor.id)}
                    >
