...
class BranchProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Variant::select([
            ...
            DB::raw('COALESCE(MAX(product_stocks.selling_price), 0) as selling_price'),
            DB::raw('COALESCE(MAX(product_stocks.cost_price), 0) as cost_price'),
            DB::raw('COALESCE(MAX(product_stocks.expiry_date)) as expiry_date'),
